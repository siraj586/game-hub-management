...
const translations = {
  en: {
    ...
    unknown_txn_excluded: "{count} unknown txn excluded",
    unknown_txns_excluded: "{count} unknown txns excluded",
    usd_received: "USD received",
    failed_close_day: "Failed to close the day. Please try again.",
  ...
  ar: {
    ...
    after_monthly_expenses: "بعد خصم تكاليف المخزون والمصاريف الشهرية",
    deducted_from_profit: "مخصوم من ربح الشهر",
    sales_capital: "رأس مال المبيعات",
    standalone_sales_cost: "تكلفة مخزون المبيعات المباشرة",
    sales: "المبيعات",
    sessions: "الجلسات",
    revenue: "الإيرادات",
    capital: "رأس المال",
    profit: "الربح",
    date: "التاريخ",
    daily_reference: "المرجع اليومي",
    daily_reference_hint: "اضغط على أي يوم لمراجعة الجلسات والمبيعات التفصيلية.",
    selected_day_details: "تفاصيل اليوم المحدد",
    session_details: "تفاصيل الجلسات",
    sales_details: "تفاصيل المبيعات",
    products: "المنتجات",
    user: "المستخدم",
    no_data_available: "لا توجد بيانات.",
    no_sales_for_day: "لا توجد مبيعات لهذا اليوم.",
    today_rate: "بسعر اليوم",
    unknown_txn_excluded: "{count} معاملة غير معروفة مستبعدة",
    unknown_txns_excluded: "{count} معاملات غير معروفة مستبعدة",
    usd_received: "المستلم بالدولار",
    failed_close_day: "فشل إغلاق اليوم. حاول مجدداً.",
    syrian_pound: "الليرة السورية",
    lebanese_pound: "الليرة اللبنانية",
    paid_in: "دُفع بـ",
